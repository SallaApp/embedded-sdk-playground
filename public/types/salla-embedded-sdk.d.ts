...
export declare interface NavModule {
    ...
    /**
     * Inject one sub-navigation item beside API-driven items.
     */
    addNavItem(item: NavItemInput): Promise<NavItemAddResult>;
    /**
     * Update previously injected items (disable, rename, etc.).
     */
    updateNavItem(item: NavItemPatchInput): void;
    /**
     * Remove injected items by opaque id (unknown ids are ignored on host).
     */
