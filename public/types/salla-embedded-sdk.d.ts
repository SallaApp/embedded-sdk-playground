...
export declare interface CheckoutModule {
   ...
   *
   * Accepts a single item object. Array input is reserved for future
   * multi-item support and will throw if used.
   *
   * @param item - Checkout item (or array, reserved for future use)
   ...
   */
  create(
    item: CheckoutItem | CheckoutItem[],
